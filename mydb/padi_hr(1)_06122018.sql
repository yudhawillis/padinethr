...
--
-- Host: 127.0.0.1:3306
-- Waktu pembuatan: 06 Des 2018 pada 02.21
-- Versi server: 5.7.23
-- Versi PHP: 7.2.10
...
(44, 12, 28, '', 1, 1, 'spv', '2018-11-07 07:40:59'),
(45, 12, 28, '', 1, 8, 'hr', '2018-11-07 07:41:33'),
(46, 1, 30, '', 1, 1, 'spv', '2018-11-27 03:55:36'),
(47, 1, 30, '', 1, 8, 'hr', '2018-11-27 06:41:07'),
(48, 1, 31, '', 1, 1, 'spv', '2018-11-28 07:33:17'),
(49, 1, 31, '', 1, 8, 'hr', '2018-11-28 07:34:52'),
(50, 12, 29, '', 1, 1, 'spv', '2018-12-05 05:02:59');
...
--
-- Struktur dari tabel `dispensation`
--
...
CREATE TABLE IF NOT EXISTS `dispensation` (
  ...
  `quota_dispensation` int(11) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `employee` (
  ...
  `employee_leave_type` varchar(50) DEFAULT NULL,
...
INSERT INTO `employee` (`id_employee`, `fullname`, `nickname`, `nik_employee`, `email`, `password`, `password_asli`, `address`, `address_2`, `birthdate`, `npwp`, `identity_number`, `phone_number`, `employee_leave_type`, `id_role`, `photo`, `status`) VALUES
(1, 'Willis Yudha', 'willis', 'PADI-8924759247', 'willis.yudha@padi.net.id', '$2y$10$Cq4YYlQoLv6RSojkj3zLTuzQFje4WZ8KOGK6WqIpG1KxmhDBc9qnO', 'admin345', '', NULL, '2014-02-22', '', '', '', 'non_extend', 1, '', 1),
(2, 'Dwi Utomo', 'Dwi', 'PADI-89247544444', 'dwi@padi.net.id', '$2y$10$W0OgbargHMAE54ig9vijn.b.hbgfEGurgdhKYCVn5WsXja9AP4ZsS', 'Gjmlcl', '', NULL, '0000-00-00', '', '', '', 'extend', 5, '', 1),
(3, 'Dhita M', 'Dhita', 'PADI-02', 'dhita@padi.net.id', '$2y$10$d9OVWCL/.u7oOrjSv0tLVeNhqDLJI99iTl6ovE2DxwrrW939Uf5Cq', 'YWb7O7', '', NULL, '0000-00-00', '', '', '', 'extend', 5, '', 1),
(4, 'Ketut A', 'Ketut', 'PADI-25', 'ketut@padi.net.id', '$2y$10$oUpbmbmcNM99ejcCS6505.jUqdpcjklPC/XEcOtEWw0efdtRLcaq6', '4WcPmY', '', NULL, '0000-00-00', '', '', '', 'extend', 4, '', 1),
(5, 'Ardi Y', 'Ardi', 'PADI-03', 'tri@padi.net.id', '$2y$10$l2TiRHkbW5aQ3IqZg1FG7Obn6gVxOt4R/SdW9UNSbXoIZx9cZLV6K', 'Z52WxA', '', NULL, '0000-00-00', '', '', '', 'extend', 5, '', 1),
(6, 'Alif', 'Alif', 'PADI-07', 'alif@padi.net.id', '$2y$10$j2Rkc8sCX8IZVYD1NE3qTufC579b8Jmz1s.hWwqUXVN75LsUvOrCe', 'v1QbZK', '', NULL, '0000-00-00', '', '', '', 'extend', 5, '', 1),
(7, 'M Zamroni', 'Zamroni', 'PADI-54', 'zamroni@gmail.com', '$2y$10$2nB0pbYsSs5DAN6tUrdZhup88ebTtvDDjnHWEYsCbYyZbLowai7yO', 'ejSdth', '', NULL, '0000-00-00', '', '', '', 'extend', 4, '', 1),
(8, 'Diana Chandra', 'Diana', 'PADI-12', 'diana@padi.net.id', '$2y$10$hnpbJIdAe6v.kwz2ti55K.2Tdl.gKP8d33fip3ehKzi9Nu67.dvY.', 'UcftWC', '', NULL, '0000-00-00', '', '', '', 'extend', 2, '', 1),
(9, 'Puji ', 'Puji', '201101-072', 'puji@padi.net.id', '$2y$10$Wbg0UKaOrB50klKDLUAHGunsFv66M2jJoERTrn65aWocsYOdBMiAW', 'coTuCm', '', NULL, '0000-00-00', '', '', '', 'extend', 5, '', 1),
(10, 'Shera Lia', 'Shera', 'PADI-45', 'shera@padi.net.id', '$2y$10$ilujbonfInyQHw3eUq1iu.u5DBJjq5ef7BLgB6kQ1fYwLpZbeZI7O', 'J7CRoc', '', '', '0000-00-00', '', '', '', 'extend', 5, '', 1),
(11, 'Yudi', 'Yudi', 'PADI00099', 'yudi@padi.net.id', '$2y$10$UV1MJ7hFRWU/7G43.4H2IOP9tV9oukzDq7EZWpIE1rSot1fC4Tswy', 'MJwB9j', '', '', '0000-00-00', '', '', '', 'extend', 5, '', 1),
(12, 'Malahatul Wardiyah', 'Mala', 'Padi34', 'mala@padi.net.id', '$2y$10$6i93WxHvR3A6tSrzmsjJtOcjSm3UTr.rUz3jsIs5DYG86X32ENUYu', 'Xi81LM', '', '', '0000-00-00', '', '', '', 'extend', 5, '', 1);
...
(1, 1, '2017-01-02', '2018-10-26', 4, 'webdev', 'marketing', 1, 7, 3, 1, NULL, 1),
...
(24, 12, '2016-04-11', '2018-08-01', 2, 'HR Recrutment', NULL, 1, 3, 3, 1, '', 0),
(25, 12, '2018-08-01', NULL, 3, 'HR Recrutment', NULL, 1, 4, 3, 1, '', 1),
(26, 1, '2018-10-26', NULL, 5, NULL, NULL, NULL, NULL, 3, NULL, NULL, NULL);
...
(1, 1, 'Adjustment', 3, '', '2018-11-27 08:39:53'),
(2, 1, 'Deduction', 1, '', '2018-11-27 08:39:59');

-- --------------------------------------------------------

--
-- Struktur dari tabel `leave_debt`
--

DROP TABLE IF EXISTS `leave_debt`;
CREATE TABLE IF NOT EXISTS `leave_debt` (
  `id_leave_debt` int(11) NOT NULL,
  `id_employee` int(11) DEFAULT NULL,
  `quota_debt` int(11) DEFAULT NULL,
  `year` int(11) DEFAULT NULL,
  PRIMARY KEY (`id_leave_debt`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1;

--
-- Dumping data untuk tabel `leave_debt`
--

INSERT INTO `leave_debt` (`id_leave_debt`, `id_employee`, `quota_debt`, `year`) VALUES
(0, 1, 0, 2017);
...
(28, '2018-11-12', '2018-11-19', '2018-11-07 07:39:15', 6, 'berlibur', 0, 0, 0, 0, 12),
(29, '2018-12-20', '2019-01-05', '2018-11-07 07:44:49', 12, 'libur lagi', 6, 0, 3, 0, 12),
(30, '2018-11-12', '2018-11-15', '2018-11-27 03:55:25', 3, 'cuti pertama kali', 0, 0, 0, 0, 1),
(31, '2018-12-28', '2019-01-02', '2018-11-28 07:33:09', 4, 'kedua dong', 0, 0, 0, 0, 1);
...
(255, 1, '2018-11-07 05:30:43'),
(256, 1, '2018-11-07 06:14:01'),
(257, 1, '2018-11-07 06:32:02'),
(258, 8, '2018-11-07 06:37:59'),
(259, 12, '2018-11-07 06:41:10'),
(260, 8, '2018-11-07 06:42:00'),
(261, 12, '2018-11-07 07:37:42'),
(262, 8, '2018-11-07 07:40:23'),
(263, 1, '2018-11-07 07:40:47'),
(264, 8, '2018-11-07 07:41:22'),
(265, 12, '2018-11-07 07:42:40'),
(266, 1, '2018-11-07 08:03:05'),
(267, 1, '2018-11-21 07:00:14'),
(268, 1, '2018-11-22 04:20:49'),
(269, 1, '2018-11-23 03:57:42'),
(270, 1, '2018-11-23 06:59:29'),
(271, 1, '2018-11-26 01:31:11'),
(272, 1, '2018-11-26 07:13:36'),
(273, 1, '2018-11-27 02:27:29'),
(274, 1, '2018-11-27 04:36:10'),
(275, 8, '2018-11-27 06:40:57'),
(276, 1, '2018-11-27 06:41:25'),
(277, 1, '2018-11-28 02:41:06'),
(278, 1, '2018-11-28 06:10:57'),
(279, 8, '2018-11-28 07:34:25'),
(280, 1, '2018-11-28 07:42:24'),
(281, 1, '2018-11-29 02:42:18'),
(282, 1, '2018-11-29 08:11:15'),
(283, 1, '2018-11-30 02:10:47'),
(284, 1, '2018-11-30 08:11:44'),
(285, 1, '2018-12-03 01:59:58'),
(286, 1, '2018-12-03 04:09:09'),
(287, 1, '2018-12-03 04:44:23'),
(288, 1, '2018-12-04 02:45:25'),
(289, 1, '2018-12-04 07:20:25'),
(290, 1, '2018-12-05 02:15:59'),
(291, 8, '2018-12-05 02:41:04'),
(292, 8, '2018-12-05 02:43:23'),
(293, 1, '2018-12-05 04:43:49'),
(294, 8, '2018-12-05 04:55:26'),
(295, 1, '2018-12-05 05:02:52'),
(296, 8, '2018-12-05 05:04:49'),
(297, 8, '2018-12-05 07:27:30');
