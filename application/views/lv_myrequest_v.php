                                    ...
                                    <div class="table-responsive">
                                        <table class="table" id="table_driver">
                                            ...
                                            <tr>
                                                <td>No</td>
                                                <td>
                                                    <a href="<?php echo base_url(); ?>leave/myrequest/search/submission_date/<?php echo $typeorder; ?>">
                                                        Submission date
                                                    </a>
                                                </td>
                                                <td>
                                                    <a href="<?php echo base_url(); ?>leave/myrequest/search/start_date/<?php echo $typeorder; ?>">
                                                        Start Date
                                                    </a>
                                                </td>
                                                <td>
                                                    <a href="<?php echo base_url(); ?>leave/myrequest/search/end_date/<?php echo $typeorder; ?>">
                                                        End Date
                                                    </a>
                                                </td>
<!--                                                <td>-->
...
<!--                                                </td>-->
                                            ...
                                            <form method="post" action="<?php echo base_url(); ?>leave/myrequest/search/orby/ortype/" />
                                            <tr>
                                                <td></td>
                                                ...
                                                <td><input type="text" data-provide="datepicker" name="search_start-date" class="form-control datepicker-search" placeholder="..."<?php
                                                    if(isset($start_date)){
                                                ...
                                                <td><input type="text" data-provide="datepicker" name="search_end_date" class="form-control datepicker-search" placeholder="..."<?php
                                                    if(isset($end_date)){
                                                        echo "value = '".$end_date."'";
                                                    }
                                                    ?>
...
//															}
                                                    ...
                                                    <td>
                                                        ...
                                                        if ($row['cancel_status']==0){
                                                            ?>
                                                            <a href="<?php echo base_url(); ?>leave/myrequest/cancel_leave/<?php echo $row['id_leave']; ?>">Cancel</a>
                                                        <?php
                                                        }
                                                        ?>
