...
$upload_dir = '/padiweb/assets/plugin/tinymce/source/'; // path from base_url to upload base dir
$current_path = '../../../../source/'; // relative path from filemanager folder to upload files folder
//willis notes :
//current_path is path untill the very first root of the path of website, use for textarea show image, see at console F12
//upload_dir is start from first folder with '/' before, without '/' after it
//base_url without '/' at ending
...
$image_width=0;//set manually yudha willis
$image_height=0;
